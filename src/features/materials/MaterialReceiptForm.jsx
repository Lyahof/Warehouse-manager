...
import { useCreateMaterialReceipt } from "./useCreateMaterialReceipt";
...
function MaterialReceiptForm({
  ...
  const { updateMaterialPlus, isPending } =
    useCreateMaterialReceipt(materialName);
